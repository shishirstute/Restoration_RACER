...
class DataLoader:
    ...
    def load_network_loads(self) -> pd.DataFrame:
        ...
        try:
            ...
            loads["bus"] = loads["bus"].astype(str) # added by shishir to cope with error
    ...
    def load_network_ders(self) -> pd.DataFrame | None:
        ...
        try:
            ...
            # added by shishir to cope with error
            DERs["name"] = DERs["name"].astype(str)
            DERs["connected_bus"] = DERs["connected_bus"].astype(str)
    ...
    def load_network_pdelements(self) -> pd.DataFrame:
        ...
        try:
            ...
            # added by shishir to cope with error
            pdelements["name"] = pdelements["name"].astype(str)
            pdelements["from_bus"] = pdelements["from_bus"].astype(str)
            pdelements["to_bus"] = pdelements["to_bus"].astype(str)
