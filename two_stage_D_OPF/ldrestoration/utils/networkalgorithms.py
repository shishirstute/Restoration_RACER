...
def network_cycles_basis(network_graph: nx.Graph) -> list[list[str]]:
    ...
    network_cycles = nx.cycle_basis(network_graph)  # commented by shishir on 10/24/2024, not required as anotehr function is created below

    # network_cycles = nx.simple_cycles(network_graph) # added by shishir
